...
export const metadata: Metadata = {
  title: 'Cookie Policy',
  description:
    'Learn about how Ephemere uses cookies to improve your experience and provide essential functionality.',
  keywords: ['cookie policy', 'cookies', 'privacy', 'data', 'ephemere'],
}

...
import { EphemereLoading } from '@/components/ui/EphemereLoading'
...
>(({ className, children, shadow = true }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'z-10 flex size-12 items-center justify-center rounded-full border-2 border-[hsl(var(--border))] bg-[hsl(var(--card))] p-3 text-[hsl(var(--muted-foreground))]',
      ...
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-6">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Circle ref={div4Ref} className="size-16">
            <EphemereLoading className="size-8" duration={5} />
          </Circle>

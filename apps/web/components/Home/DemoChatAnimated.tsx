...
const DemoChatAnimated = () => {
  return (
    <BlurFadeIn
      ...
      blur={true}
    >
      <div className="w-full rounded-xl border-2 border-[hsl(var(--border))] bg-[hsl(var(--card))] md:w-[95%] lg:w-[70%]">
        <div className="border-b-2 border-[hsl(var(--border))] p-2 px-3 sm:px-5">
        ...
        <div className="relative h-fit p-4 sm:p-6 md:p-8 lg:p-10">
          <GridPattern
            ...
            className={cn(
              ...
              'fill-[hsl(var(--primary)/0.12)] stroke-[hsl(var(--divider))]'
            )}
          />
          <ChatMessages />
        </div>
